package cn.com.dhcc.license.client.controller;
 ...
 **/
@RestController
@RequestMapping("/expire/warn")
public class ExpireWarnController {
	private static final Logger logger = LoggerFactory.getLogger(ExpireWarnController.class);
